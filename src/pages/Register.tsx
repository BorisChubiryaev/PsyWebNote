    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Создайте аккаунт психолога</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/60 p-8 border border-gray-100">
          ...
          >
            ...
            {googleLoading ? 'Создаём аккаунт...' : 'Зарегистрироваться через Google'}
          </button>
        ...
        <p className="text-center text-xs text-gray-400 mt-6 px-4">
          Регистрируясь, вы соглашаетесь с условиями использования сервиса. Данные клиентов хранятся в зашифрованном виде.
        </p>
      </div>
    </div>
  );
